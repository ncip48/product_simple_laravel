                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="privacy_content section_3">
                            ...
                            <p>By accessing
this web site, you are agreeing to be bound by these Terms and Conditions of
...
materials contained in this web site are protected by applicable copyright and <span>trade mark</span> law. </span></p>
                        </div>
                        <div class="privacy_content section_3">
                            <h2>License</h2>
                            <p>Permission is granted to temporarily download one copy of the materials (information or software) on GPBMScript web site for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:

 

modify or copy the materials;

use the materials for any commercial purpose, attempt to decompile or reverse engineer any software contained on GPBMScript's web site. remove any copyright or other proprietary notations from the materials.</p>
                        </div>
                        <div class="privacy_content section_3">
                            <h2>Subscription</h2>
                            <p>The subscription is valid for the time purchased. When expired, the user is required to renew it manually.
...
Subscriptions may be terminated by GBPMScript at any time without warning and without liability, whether financial or not.</p>
                        </div>
                         <div class="privacy_content section_3">
